...
def RunMSAEA():
    ...
    np.savetxt('./MSAEA_0.33_Data/F{}_{}D.csv'.format(Fun_num, DIMENSION_NUM), All_Trial_Best, delimiter=",")
...
if __name__ == "__main__":
    if os.path.exists('./MSAEA_0.33_Data') == False:
        os.makedirs('./MSAEA_0.33_Data')
    main_10()
    # main_30()
    # main_50()